...
// Hell-themed colors
const brimstone = Color(0x8b, 0x00, 0x00);  // Dark red
const darkBrimstone = Color(0x55, 0x00, 0x00);  // Darker red
const obsidian = Color(0x0f, 0x0f, 0x0f);
const darkObsidian = Color(0x05, 0x05, 0x05);
const lava = Color(0xff, 0x4d, 0x00);
const moltenOrange = Color(0xff, 0x69, 0x00);
const moltenRed = Color(0xdc, 0x14, 0x3c);
const hellAsh = Color(0x66, 0x66, 0x66);
const darkHellAsh = Color(0x33, 0x33, 0x33);
const charcoal = Color(0x1a, 0x1a, 0x1a);
const burntOrange = Color(0xcc, 0x33, 0x00);
const hellFire = Color(0xff, 0x33, 0x00);
const crimson = Color(0xdc, 0x14, 0x3c);  // Deep red
const darkCrimson = Color(0x8b, 0x00, 0x00);  // Very dark red
const boneWhite = Color(0xf5, 0xf5, 0xdc);  // Off-white for furniture
const ironGray = Color(0x80, 0x80, 0x80);  // Medium gray for metal
